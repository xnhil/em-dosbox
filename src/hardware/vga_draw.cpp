...
static chtype vga2unicode(unsigned char c) {
	static const short vga2uni_tab[256] = {
		/* 00 */ 0X0000, 0X0001, 0X0002, 0x2665, 0x2666, 0x2663, 0x2660, 'x',
		/* 08 */ 0X0008, 0x26AA, 0X000A, 0X000B, 0X000C, 0X000D, 0X000E, 0X000F,
		/* 10 */ 0X0010, 0X0011, 0X0012, 0X0013, 0X0014, 0X0015, 0X0016, 0X0017,
		/* 18 */ 0x2191, 0x2193, 0x2192, 0x2190, 0X001C, 0X001D, 0X001E, 0X001F,
		/* 20 */    ' ',    '!',    '"',    '#',    '$',    '%',    '&',   '\'',
		/* 28 */    '(',    ')',    '*',    '+',    ',',    '-',    '.',    '/',
		/* 30 */    '0',    '1',    '2',    '3',    '4',    '5',    '6',    '7',
		/* 38 */    '8',    '9',    ':',    ';',    '<',    '=',    '>',    '?',
		...
		/* A8 */ 0X00A8, 0X00A9, 0X00AA, 0X00AB, 0X00AC, 0X00AD, 0x00AB, 0x00BB,
